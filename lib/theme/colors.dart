...
class AppColorsOrange {
  ...
  static const Color secondary = Color(0xFFE38D36);
  static const Color accent = Color(0xFFF5810B);
...
class AppColorsTurquise {
  ...
  static const Color secondary = Color(0xFF28C79A);
  static const Color accent = Color(0xFF3B947B);
  static const Color text = Color(0xFF131918); 
}